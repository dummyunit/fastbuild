...
void TestCompilationDatabase::TestObjectListInputFile() const
{
    DoTest( "Tools/FBuild/FBuildTest/Data/TestCompilationDatabase/fbuild.bff", "ObjectList_InputFile",
        ...
        "  {\n"
        "    \"directory\": \"WORKDIR_\",\n"
        "    \"file\": \"TESTDIR_file.cpp\",\n"
        "    \"output\": \"OUTDIR_file.result\",\n"
        "    \"arguments\": [\"TESTDIR_clang\", \"-c\", \"-Ipath with spaces\", \"-DSTRING_DEFINE=\\\"foobar\\\"\", \"TESTDIR_file.cpp\", \"-o\", \"OUTDIR_file.result\"]\n"
        "  }\n"
        "]\n"
    );
}
...
void TestCompilationDatabase::TestObjectListInputPath() const
{
    DoTest( "Tools/FBuild/FBuildTest/Data/TestCompilationDatabase/fbuild.bff", "ObjectList_InputPath",
        ...
        "  {\n"
        "    \"directory\": \"WORKDIR_\",\n"
        "    \"file\": \"TESTDIR_dirSLASH_subdirSLASH_file.cpp\",\n"
        "    \"output\": \"OUTDIR_subdirSLASH_file.result\",\n"
        "    \"arguments\": [\"TESTDIR_clang\", \"-c\", \"-Ipath with spaces\", \"-DSTRING_DEFINE=\\\"foobar\\\"\", \"TESTDIR_dirSLASH_subdirSLASH_file.cpp\", \"-o\", \"OUTDIR_subdirSLASH_file.result\"]\n"
        "  }\n"
        "]\n"
    );
}
...
/*static*/ void TestCompilationDatabase::PrepareExpectedResult( AString & result )
{
    ...
    result.Replace( "WORKDIR_", workDir.Get() );
    result.Replace( "TESTDIR_", testDir.Get() );
    result.Replace( "OUTDIR_", outDir.Get() );
    result.Replace( "SLASH_", slash.Get() );
}
