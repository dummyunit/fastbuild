...
{
    if ( !node->GetPreBuildDependencies().IsEmpty() )
        FLOG_WARN( "%s '%s' has pre-build dependencies. Files generated by pre-build dependencies will not be included in the compilation database unless they already exist.\n", node->GetTypeName(), node->GetName().Get() );
